            ...
            <div class="flex flex-col md:flex-row items-stretch gap-2 md:gap-6">
              ...
              <div class="w-full md:w-1/2 py-10 px-6 md:px-12 flex flex-col justify-center">
                ...
                <div class="flex flex-col gap-4">
                  ...
                  <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-600"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="4 7 4 4 20 4 20 7"></polyline><line x1="9" y1="20" x2="15" y2="20"></line><line x1="12" y1="4" x2="12" y2="20"></line></svg></div>
          ...
          <div class="sticky top-40 z-[3] bg-white rounded-lg border border-slate-200 p-[5px] transition-all">
            <div class="flex flex-col md:flex-row items-stretch gap-2 md:gap-6">
              ...
              <div class="w-full md:w-1/2 py-10 px-6 md:px-12 flex flex-col justify-center">
                ...
                <div class="flex flex-col gap-4">
                  <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-600"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline></svg></div>
                  ...
                  <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-600"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg></div>
            ...
            <div class="flex flex-col md:flex-row-reverse items-stretch gap-2 md:gap-6">
              ...
              <div class="w-full md:w-1/2 py-10 px-6 md:px-12 flex flex-col justify-center">
                ...
                <div class="flex flex-col gap-4">
                  ...
                  <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-600"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><path d="M12 16v-4"></path><path d="M12 8h.01"></path></svg></div>
                    <span class="text-slate-700 font-medium text-[14px]">Gợi ý tư duy giải bài</span>
                  </div>
                  <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-600"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg></div>
                  ...
                  <div class="relative z-10 w-full max-w-[320px] bg-white rounded-xl shadow-sm border border-slate-100 p-7 scale-105">
                     <div class="flex items-center gap-3 mb-6">
                       <div class="w-8 h-8 rounded-lg bg-green-100 flex items-center justify-center">
                         <svg width="16" height="16" viewBox="0 0 24 24" class="text-green-600" fill="none" stroke="currentColor" stroke-width="3"><polyline points="20 6 9 17 4 12"></polyline></svg>
                       </div>
